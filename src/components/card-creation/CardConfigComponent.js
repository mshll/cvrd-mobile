              ...
              {LIMIT_OPTIONS.map((option, index) => {
                ...
                return (
                  <Button
                    key={option.id}
                    backgroundColor={
                      isSelected ? colors.primary : hasValue ? colors.primaryDark : colors.backgroundTertiary
                    }
                    pressStyle={{
                      backgroundColor: isSelected ? colors.primaryDark : colors.backgroundTertiary,
                    }}
                    onPress={() => {
                    ...
                    {...borderRadius}
                  >
                    <Text color={isSelected || hasValue ? 'white' : colors.text} fontSize="$3" fontWeight="600">
                      {option.label}
                    </Text>
                  </Button>
                );
